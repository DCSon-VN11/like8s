            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="card border-0">
                        <div class="card-body">
                            <h3 class="card-title font-size-17">Tăng Follow - Theo dõi Tiktok</h3>
                                ...
                                <div class="tab-pane active" id="home1" role="tabpanel">
                                    <form action="#" method="post" id="form_buy" class="needs-validation"
                                                ...
                                                <div class="prices">
                                                    <div class="mx-0">
                                                        <input checked="" class="select-price" type="radio"
                                                            ...
                                                            name="package_type" data-price="20" value="follow">
                                                        <label for="control_follow">
                                                            ...
                                                            <p class="font-size-12 mb-0 fw-normal">
                                                                Tăng tối đa 10.000, clone việt có avatar và không được
                                                                bảo hành.
                                                            </p>
                                                        </label>
                                                    </div>
                                                    <div class="mx-0">
                                                        <input class="select-price" type="radio"
                                                            ...
                                                            name="package_type" data-price="30" value="follow_speed">
                                                        <label for="control_follow_speed">
                                                            <h5 class="font-size-16 fw-bold mb-1">Follow nhanh</h5>
                                                            <h5 class="font-size-16 fw-bold">30
                                                                xu /
                                                                follow
                                                            </h5>
                                                            <p class="font-size-12 mb-0 fw-normal">
                                                                Chạy siêu nhanh, tăng tối đa 10.000, clone việt có
                                                                avatar và không được bảo hành.
                                                            </p>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <input style="display: none" name="type" value="follow"><input
                                            style="display: none" name="provider" value="tiktok">
