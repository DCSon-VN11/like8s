            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="card border-0">
                        <div class="card-body">
                            <h3 class="card-title font-size-17">Tăng Chia Sẻ Bài Viết</h3>
                            ...
                            <div class="tab-content p-3 mt-3">
                                <div class="tab-pane active" id="home1" role="tabpanel">
                                    <form action="#" method="post" id="form_buy" class="needs-validation"
                                                ...
                                                <div class="prices">
                                                    <div class="mx-0">
                                                        <input checked="" class="select-price" type="radio"
                                                            onchange="checkCoin()" id="control_share_speed"
                                                            name="package_type" data-price="300" value="share_speed">
                                                        <label for="control_share_speed">
                                                            <h5 class="font-size-16 fw-bold mb-1">Tốc độ nhanh</h5>
                                                            <h5 class="font-size-16 fw-bold">300
                                                                xu /
                                                                share
                                                            </h5>
                                                            <p class="font-size-12 mb-0 fw-normal">
                                                                Tăng tối đa 50.000. Trong thời gian bão Facebook, gói
                                                                này sẽ được ưu tiên về tốc độ cho đến khi facebook hết
                                                                quét.
                                                            </p>
                                                        </label>
                                                    </div>
                                                    <div class="mx-0">
                                                        <input class="select-price" type="radio"
                                                            onchange="checkCoin()" id="control_share"
                                                            name="package_type" data-price="100" value="share">
                                                        <label for="control_share">
                                                            <h5 class="font-size-16 fw-bold mb-1">Tốc độ thường</h5>
                                                            <h5 class="font-size-16 fw-bold">100
                                                                xu /
                                                                share
                                                            </h5>
                                                            <p class="font-size-12 mb-0 fw-normal">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <select name="speed" class="form-control" onchange="checkCoin()">
                                                    ...
                                                    <option value="5">5 Giây / 1 share</option>
                                                    <option value="10">10 Giây / 1 share</option>
                                                    <option value="15">15 Giây / 1 share</option>
                                                    <option value="20">20 Giây / 1 share</option>
                                                    <option value="25">25 Giây / 1 share</option>
                                                    <option value="30">30 Giây / 1 share</option>
                                                    <option value="35">35 Giây / 1 share</option>
                                                    <option value="40">40 Giây / 1 share</option>
                                                    <option value="45">45 Giây / 1 share</option>
                                                    <option value="50">50 Giây / 1 share</option>
                                                    <option value="55">55 Giây / 1 share</option>
                                                    <option value="60">60 Giây / 1 share</option>
                                                    <option value="65">65 Giây / 1 share</option>
                                                    <option value="70">70 Giây / 1 share</option>
                                                    <option value="75">75 Giây / 1 share</option>
                                                    <option value="80">80 Giây / 1 share</option>
                                                    <option value="85">85 Giây / 1 share</option>
                                                    <option value="90">90 Giây / 1 share</option>
                                                    <option value="95">95 Giây / 1 share</option>
                                                    <option value="100">100 Giây / 1 share</option>
                                                    <option value="105">105 Giây / 1 share</option>
                                                    <option value="110">110 Giây / 1 share</option>
                                                    <option value="115">115 Giây / 1 share</option>
                                                    <option value="120">120 Giây / 1 share</option>
                                                    <option value="125">125 Giây / 1 share</option>
                                                    <option value="130">130 Giây / 1 share</option>
                                                    <option value="135">135 Giây / 1 share</option>
                                                    <option value="140">140 Giây / 1 share</option>
                                                    <option value="145">145 Giây / 1 share</option>
                                                    <option value="150">150 Giây / 1 share</option>
                                                    <option value="155">155 Giây / 1 share</option>
                                                    <option value="160">160 Giây / 1 share</option>
                                                    <option value="165">165 Giây / 1 share</option>
                                                    <option value="170">170 Giây / 1 share</option>
                                                    <option value="175">175 Giây / 1 share</option>
                                                    <option value="180">180 Giây / 1 share</option>
                                                    <option value="185">185 Giây / 1 share</option>
                                                    <option value="190">190 Giây / 1 share</option>
                                                    <option value="195">195 Giây / 1 share</option>
                                                    <option value="200">200 Giây / 1 share</option>
                                                    <option value="205">205 Giây / 1 share</option>
                                                    <option value="210">210 Giây / 1 share</option>
                                                    <option value="215">215 Giây / 1 share</option>
                                                    <option value="220">220 Giây / 1 share</option>
                                                    <option value="225">225 Giây / 1 share</option>
                                                    <option value="230">230 Giây / 1 share</option>
                                                    <option value="235">235 Giây / 1 share</option>
                                                    <option value="240">240 Giây / 1 share</option>
                                                    <option value="245">245 Giây / 1 share</option>
                                                    <option value="250">250 Giây / 1 share</option>
                                                    <option value="255">255 Giây / 1 share</option>
                                                    <option value="260">260 Giây / 1 share</option>
                                                    <option value="265">265 Giây / 1 share</option>
                                                    <option value="270">270 Giây / 1 share</option>
                                                    <option value="275">275 Giây / 1 share</option>
                                                    <option value="280">280 Giây / 1 share</option>
                                                    <option value="285">285 Giây / 1 share</option>
                                                    <option value="290">290 Giây / 1 share</option>
                                                    <option value="295">295 Giây / 1 share</option>
                                                    <option value="300">300 Giây / 1 share</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                        ...
                                        <input style="display: none" name="type" value="share"><input
                                        ...
                                        <div class="thành blog_right_sidebar text-center mt-3">
                                            ...
                                            <h1 class="fw-bold text-success">
                                                <span id="txt_check_out_coin">15,000</span>
                                                Xu
                                            </h1>
                                            <h6 class="fw-bold mb-0 text-success mb-md-3 mb-0">
                                                Bạn sẽ mua <span id="txt_quantity">50</span> <span
                                                    ...
                                                    id="txt_price_per">300</span>xu/1
