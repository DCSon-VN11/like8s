            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="card border-0">
                        <div class="card-body">
                            <h3 class="card-title font-size-17">Tăng Follow - Theo dõi Instagram</h3>
                                    ...
                                    <form action="#" method="post" id="form_buy" class="needs-validation"
                                        ...
                                        <div class="row mb-sm-4 mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="prices">
                                                    <div class="mx-0">
                                                        <input checked="" class="disable-price" type="radio"
                                                            onchange="checkCoin()" id="control_follow"
                                                            name="package_type" data-price="30" value="follow">
                                                        <label for="control_follow">
                                                            <h5 class="font-size-16 fw-bold mb-1">Follow chất lượng</h5>
                                                    ...
                                                    <div class="mx-0">
                                                        <input class="disable-price" type="radio"
                                                            onchange="checkCoin()" id="control_follow_sale"
                                                            name="package_type" data-price="15" value="follow_sale">
                                                        <label for="control_follow_sale">
                                                            <h5 class="font-size-16 fw-bold mb-1">Follow giá rẻ</h5>
                                        ...
                                        <div class="row mb-sm-4">
                                            <label for="horizontal-firstname-input"
                                                class="col-sm-2 col-form-label text-danger fw-bold">Cách công khai theo
                                                dõi</label>
                                            <div class="col-sm-3 col-12">
                                                <img src="../image/instagram_follow_1.png"
                                                    alt="Bước 1" class="img-fluid mx-auto d-block">
                                            </div>
                                            <div class="col-sm-3 col-12">
                                                <img src="../image/instagram_follow_2.png"
                                                    alt="Bước 2" class="img-fluid mx-auto d-block">
                                            </div>
                                            <div class="col-sm-3 col-12">
                                                <img src="../image/instagram_follow_3.png"
                                                    alt="Bước 3" class="img-fluid mx-auto d-block">
                                            </div>
                                        </div>
                                        ...
                                        <div class="thành blog_right_sidebar text-center mt-3">
                                            ...
                                            <h1 class="fw-bold text-success">
                                                <span id="txt_check_out_coin">1,500</span>
                                                Xu
                                            </h1>
