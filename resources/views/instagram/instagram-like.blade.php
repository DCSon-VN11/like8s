            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="card border-0">
                        <div class="card-body">
                            <h3 class="card-title font-size-17">Tăng Like bài viết Instagram</h3>
                                                ...
                                                <div class="prices">
                                                    <div class="mx-0">
                                                        <input checked="" class="select-price" type="radio"
                                                            onchange="checkCoin()" id="control_like" name="package_type"
                                                            data-price="20" value="like">
                                                        <label for="control_like">
                                                            <h5 class="font-size-16 fw-bold mb-1">Like chất lượng</h5>
                                                            <h5 class="font-size-16 fw-bold">20
                                                                xu /
                                                                like
                                                            </h5>
                                                            <p class="font-size-12 mb-0 fw-normal">
                                                                Tăng tối đa 50.000. Gói này chạy bằng tài nguyên xịn hơn
                                                    ...
                                                    <div class="mx-0">
                                                        <input class="select-price" type="radio"
                                                            onchange="checkCoin()" id="control_like_sale"
                                                            name="package_type" data-price="10" value="like_sale">
                                                        <label for="control_like_sale">
                                                            <h5 class="font-size-16 fw-bold mb-1">Like giá rẻ</h5>
                                                            <h5 class="font-size-16 fw-bold">10
                                                                xu /
                                                                like
                                                            </h5>
                                                            <p class="font-size-12 mb-0 fw-normal">
                                                                Tăng tối đa 50.000. Gói này chạy bằng clone để đáp ứng
                                                                nhu cầu giá rẻ và không được bảo hành.
                                                            </p>
                                                        </label>
                                                    </div>
                                                </div>
